...
public class TwoCharacters
{
	...
	public static String pickColor()
	{
		...
		System.out.print("Choose a color for your character >> ");
	...
	{
		System.out.println("Your character has " + ch.getLives() + " lives. It has " + ch.getNumberOfEyes() + " eyes. And its color is " + ch.getColor());
	}
	
	public static void display2(MyCharacter ch)
	{
		System.out.println("Your second character has " + ch.getLives() + " lives. It has " + ch.getNumberOfEyes() + " eyes. And its color is " + ch.getColor());
	}
}